...
$route['introduction'] = 'welcome/introduction';
$route['about'] = 'welcome/about';
$route['key-milestone'] = 'welcome/key_milestone';
$route['bod'] = 'welcome/bod';
$route['bod-details/(:any)'] = 'welcome/bod_details/$1';
$route['download'] = 'welcome/download';
$route['contact'] = 'welcome/contact';
$route['working-invironment'] = 'welcome/working_invironment';
$route['job-vacancy'] = 'welcome/job_vacancy';
$route['service-details-page/(:any)'] = 'welcome/service_details_page/$1';
$route['lumitech-chemicals-and-dyes'] = 'welcome/lumitech_chemicals_and_dyes';
$route['lumitech-professional-lighting'] = 'welcome/lumitech_professional_lighting';
$route['lumitech-power'] = 'welcome/lumitech_power';
$route['lumitech-construction'] = 'welcome/lumitech_construction';
$route['lumitech-organic'] = 'welcome/lumitech_organic';
$route['lumitech-denim-fabric-and-garments'] = 'welcome/lumitech_denim_fabric_and_garments';
$route['denim-febrics'] = 'welcome/denim_febrics';
$route['ready-germents'] = 'welcome/ready_germents';
...
$route['msg-status-change/(:any)/(:any)'] = 'dashboard/msg_status_change/$1/$2';
...
$route['catalogue-list'] = 'catalogue/catalogue_list';
$route['catalogue-add'] = 'catalogue/catalogue_add';
$route['catalogue-save'] = 'catalogue/catalogue_save';
$route['edit-catalogue/(:any)'] = 'catalogue/edit_catalogue/$1';
$route['catalogue-update'] = 'catalogue/catalogue_update';
$route['delete-status-catalogue/(:any)'] = 'catalogue/delete_status_catalogue/$1';
...
$route['bod-list'] = 'bod/bod_list';
$route['bod-add'] = 'bod/bod_add';
$route['bod-save'] = 'bod/bod_save';
$route['edit-bod/(:any)'] = 'bod/edit_bod/$1';
$route['bod-update'] = 'bod/bod_update';
$route['delete-status-bod/(:any)'] = 'bod/delete_status_bod/$1';
...
$route['edit-product-category/(:any)'] = 'products/edit_product_category_form/$1';
$route['edit-product/(:any)'] = 'products/edit_product_form/$1';
$route['delete-status-product-category/(:any)'] = 'products/delete_status_product_category/$1';
$route['delete-status-product/(:any)'] = 'products/delete_status_product/$1';
$route['products-category-update'] = 'products/products_category_update';
