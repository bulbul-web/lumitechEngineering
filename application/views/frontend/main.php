...
<main role="main">
    ...
    <div class="line">
        ...
        ?>
            ...
            <!-- <div class="item">
                <div class="s-12 center">
                <img src="<?php echo base_url();?>assets/frontend/img/02-boxed.jpg" alt="">
                <div class="carousel-content">
                    <div class="padding-2x">
                    <div class="s-12 m-12 l-8">
    ...
    <div class="line">
        ...
        <div class="s-12 m-12 l-4 margin-m-bottom">
            <img class="margin-bottom" src="<?php echo base_url();?>assets/frontend/img/img-01.jpg" alt="">
            <h2 class="text-thin">Clean Design</h2>
            <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.</p> 
            <a class="text-more-info text-primary-hover" href="/">Read more</a>                
        </div>
        <div class="s-12 m-12 l-4 margin-m-bottom">
            <img class="margin-bottom" src="<?php echo base_url();?>assets/frontend/img/img-02.jpg" alt="">
            <h2 class="text-thin">Valid code</h2>
            <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.</p> 
            <a class="text-more-info text-primary-hover" href="/">Read more</a>                
        </div>
        <div class="s-12 m-12 l-4 margin-m-bottom">
            <img class="margin-bottom" src="<?php echo base_url();?>assets/frontend/img/img-03.jpg" alt="">
