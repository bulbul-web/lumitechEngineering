...
<footer>
      ...
      <section class="padding background-dark">
        <div class="line">
          <div class="s-12 l-6">
            <p class="text-size-12">Copyright 2021, LumiTech</p>
            <p class="text-size-12">All right reserved.</p>
          </div>
          <div class="s-12 l-6">
            <a class="right text-size-12" target="_BLANK" href="https://jaisbd.com/" title="Responsee - lightweight responsive framework">Developed<br> by J A IT Solution</a>
          </div>
        </div>
      </section>
